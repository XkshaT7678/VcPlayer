...
from VcPlayer.config import ARQ_API_KEY
from VcPlayer.config import BOT_NAME as bn
from VcPlayer.config import DURATION_LIMIT
from VcPlayer.config import UPDATES_CHANNEL as updateschannel
from VcPlayer.config import que
from VcPlayer.function.admins import admins as a
from VcPlayer.helpers.admins import get_administrators
from VcPlayer.helpers.channelmusic import get_chat_id
from VcPlayer.helpers.decorators import authorized_users_only
from VcPlayer.helpers.filters import command, other_filters
from VcPlayer.helpers.gets import get_file_name
from VcPlayer.services.callsmusic import callsmusic
from VcPlayer.services.callsmusic import client as USER
from VcPlayer.services.converter.converter import convert
from VcPlayer.services.downloaders import youtube
from VcPlayer.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @AlkiNub to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
